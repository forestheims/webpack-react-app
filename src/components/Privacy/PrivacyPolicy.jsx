...
const PrivacyPolicy = () => (
  <div className="flex flex-col text-left w-7/12 py-20 gap-2">
    ...
    <ul>
      <li>
        Your Google account&apos;s basic profile information, such as your name,
    ...
    <ul>
      ...
      rights, property, or safety of our application, our users, or others. Data
      Security We implement a variety of security measures to maintain the
    ...
    <p>
      ...
      and are not responsible for the privacy practices of Google. We encourage
      you to review Google&apos;s privacy policy for more information.
    </p>
    ...
    <p>
      ...
      hesitate to contact us at [Your Contact Information].
    </p>
  </div>
);
